...
def main():
    ...
    ResaNet_para_idx = [str(i) for i in range(17,18)]
    ...
    if resa_train: # cfg.TRAIN.RESANET_ONLY = True
        pass
    """
    if rank in [-1, 0]:
    ...
    if resa_train: #cfg.TRAIN.RESANET_ONLY
        ...
        # just for test
            ...
            img_path = "./inference/images/vx3"
            img_list = os.listdir(img_path)
            print("input_img = ",img_list)
            runner.demo(img_path,img_list)
        else:
            runner.train()
